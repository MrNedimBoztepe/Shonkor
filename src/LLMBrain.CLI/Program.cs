...
namespace LLMBrain.CLI;

public static class Program
{
    private const string DefaultConfigFileName = "llmbrain.json";
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        switch (command)
        {
            ...
            default:
                ...
                Console.ResetColor();
                Console.WriteLine("Run 'llmbrain help' or 'llmbrain --help' for usage instructions.");
                return 1;
        }
    }
    ...
    private static void PrintHelp()
    {
        ...
        Console.WriteLine(@"==========================================================================");
        Console.WriteLine(@" LLMBrain CLI - Precision GraphRAG Source Code & Documentation Indexer");
        Console.WriteLine(@"==========================================================================");
        Console.ResetColor();
        Console.WriteLine("Usage:");
        Console.WriteLine("  llmbrain <command> [arguments] [options]");
        Console.WriteLine();
        Console.WriteLine("Commands:");
        Console.ForegroundColor = ConsoleColor.Yellow;
        Console.Write("  init    ");
        Console.ResetColor();
        Console.WriteLine("Initialize default 'llmbrain.json' configuration in the current directory.");
        ...
        Console.WriteLine("    -c, --config <file>      Path to config json file (defaults to 'llmbrain.json')");
        Console.WriteLine();
        ...
        Console.WriteLine("    -o, --out <path>         Output Markdown capsule file path (defaults to 'llmbrain-capsule.md')");
        Console.WriteLine("    -c, --config <file>      Path to config json file (defaults to 'llmbrain.json')");
        Console.WriteLine(@"==========================================================================");
    }
    ...
    private static async Task<int> ParseAndRunSearchAsync(string[] args)
    {
        if (args.Length < 2)
        {
            ...
            Console.ResetColor();
            Console.WriteLine("Usage: llmbrain search <query> [-l/--limit <limit>] [-c/--config <configPath>]");
            return 1;
        }
    ...
    private static async Task<int> ParseAndRunCapsuleAsync(string[] args)
    {
        if (args.Length < 2)
        {
            ...
            Console.ResetColor();
            Console.WriteLine("Usage: llmbrain capsule <query> [-h/--hops <hops>] [-o/--out <outPath>] [-c/--config <configPath>]");
            return 1;
        }

        var query = args[1];
        var hops = 2;
        var outPath = "llmbrain-capsule.md";
        var configPath = DefaultConfigFileName;
